...
tok4_clean_title_log_odds_dict = json.load(open('tok4_clean_emp_title_log_odds_with_border_toks.json','r'))
...
tok4_capitalization_log_odds_dict = json.load(open('tok4_capitalization_log_odds.json','r'))
...
dv = ['loan_amnt', 'int_rate', 'installment', 'term', 'sub_grade', 'purpose', 
      ...
      'clean_title_rank',
      'short_title_rank', 
      'mod_rate', 'med_inc', 'pct_med_inc', 'pymt_pct_inc','hpa4', 
      'tok4_clean_title_log_odds', 'tok4_capitalization_log_odds' ]
